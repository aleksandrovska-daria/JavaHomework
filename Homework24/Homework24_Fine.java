...
public class Homework24_Fine {
    ...
    public Homework24_Fine() {
    }

    public Homework24_Fine(String name) {
        this.name = name;
    }


    public Homework24_Fine(Map<String, Integer> fineSet) {
        this.fineSet = fineSet;
    }

    public Homework24_Fine(String name, Map<String, Integer> fineSet) {
        this.name = name;
        this.fineSet = fineSet;
    }
